<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"U:\house\public/../application/index\view\user\login.html";i:1571627657;s:51:"U:\house\application\index\view\layout\default.html";i:1571627654;s:48:"U:\house\application\index\view\common\meta.html";i:1562338655;s:50:"U:\house\application\index\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<form name="form" id="login-form" class="form-vertical" method="POST" action="">
	...
	<div class="login">
		...
		<div class="layadmin-user-login-box layadmin-user-login-body layui-form"  for="account">
  			...
  			<input class="inputmb" type="text" name="account" data-rule="required" placeholder="<?php echo __('Email/Mobile/Username'); ?>">
  			...
  			<div class="inputtxt mt15 btn-forgot"><a href="#">忘记密码？</a></div>
  			<button class="lgbt mt15" lay-submit id="LAY-user-login-submit" lay-filter="LAY-user-login-submit">登&nbsp;&nbsp;录</button>
		</div>
		<div class="reg"><a href="<?php echo url('register'); ?>">没有账号？立即注册</a></div>
		</div>
	</div>
</form>
</div>
